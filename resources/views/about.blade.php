    ...
    <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32 m-4 rounded-lg">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                ...
                <p class="mt-8 text-lg font-medium text-pretty text-gray-300 sm:text-xl/8">Quality of Service: Emphasize the high quality of service you provide and any awards or recognitions you have received.</p>
                <p class="mt-8 text-lg font-medium text-pretty text-gray-300 sm:text-xl/8">Customer Satisfaction: Highlight customer testimonials, satisfaction rates, and any guarantees you offer.</p>
            </div>
